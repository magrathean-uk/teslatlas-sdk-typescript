...
ADAPTER_ID = "typescript_browser"
CONTRACT_REVISION = 1
PRODUCT_VERSION = "2026.36.2"
PROFILE_SHA256 = "b80d940e8edd15896c797f659dd76e08c8b2cf2229e8386d96342b1fa4c7d926"
ACTOR_ID = "sdk_browser"
ACTOR_KIND = "packed_sdk_browser"
RUNTIME_REF = "root_browser"
ENTRYPOINT_REF = "sdk_browser_worker"
...
def validate_manifest(path):
    ...
    if any(not isinstance(item, dict) or set(item) != required_case_keys or item.get("actor_ids") != [ACTOR_ID] or item.get("raw_schema_ids") != ["typescript-browser-raw-v1"] or item.get("evidence_kind") != CASE_KINDS.get(item.get("id")) for item in value["cases"]):
    ...
    if len(value["raw_schemas"]) != 1 or value["raw_schemas"][0].get("id") != "typescript-browser-raw-v1":
